$(document).ready(function () {
    ...
    $.ajax({
        url: "https://dev.smartbothub.com/3000/getIncompleteBookings",
        type: "GET",
        headers: {},
        crossDomain: true,
        success: function (res) {
            ...
            if (botData) {
                ...
                for (var i = 0; i < botData.data.length; i++) {
                    let bDate = new Date(parseInt(botData.data[i].timestamp));
    ...
    function initGraph() {
        ...
        document.getElementById('incomplete-bookings-count').innerHTML = botData.total ? botData.total : 0
        var data = {
            labels: bookingArr,
            datasets: [{
        ...
        var lineOptions = {
            ...
            title: {
                display: true,
                text: 'No. of Incomplete Bookings',
                fontSize: 14
            },
            legend: {
                display: true
        ...
        var lineChartCanvas = document.getElementById("incomplete-bookings-chart").getContext('2d');;
