$(document).ready(function () {
    ...
    $.ajax({
        url: "https://dev.smartbothub.com/3000/getApiFailCount",
        type: "GET",
        headers: {},
        crossDomain: true,
        success: function (res) {
            ...
            if (botData) {
                ...
                document.getElementById('failed-api-count').innerHTML = botData.total ? botData.total : 0;
                initGraph();
                beforePrintHandler();
            }
    ...
    function initGraph() {
        ...
        var lineOptions = {
            ...
            title: {
                display: true,
                text: 'No. of failed Bookings due to API errors',
                fontSize: 14
            },
            legend: {
                display: true
        ...
        var lineChartCanvas = document.getElementById("api-error-chart").getContext('2d');;
